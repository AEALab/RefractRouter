...
export interface PlanningConfig {
  schemaVersion:'refractagent-planning-v1'|'refractagent-planning-v2'; enabled:boolean; defaultStrategy?:PlanningStrategy
...
export const EMPTY_PLANNING:PlanningConfig={schemaVersion:'refractagent-planning-v2',enabled:false,defaultStrategy:'stage'}
...
export const PLANNING_PROTOCOL='refractagent-planning/2'
...
export function validatePlanningShape(value:unknown):asserts value is PlanningConfig {
  ...
  if(!['refractagent-planning-v1','refractagent-planning-v2'].includes(String(v.schemaVersion))||typeof v.enabled!=='boolean')
