...
前沿使用平均独立质量分与平均生产费用；p95 时延单列。不完整策略不参与前沿判定。

| 策略 | 平均质量 | 平均生产费用（AFP） | p95 时延（ms） | 位于质量费用前沿 |
|---|---:|---:|---:|:---:|
| `node-oracle` | 92.000 | 5.50523333 | 96785 | 是 |
| `node-type-rule` | 85.667 | 3.90506667 | 77635 | 是 |
| `strong-all` | 88.333 | 7.70696667 | 105662 | 否 |
| `task-oracle` | 94.500 | 2.76920000 | 61174 | 否 |
| `weak-all` | 90.500 | 0.56832500 | 49694 | 否 |
