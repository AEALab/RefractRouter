...
2026-09-07 已在独立授权下完成两次真实调用：评分 28／91，校准通过，费用 8.68545 AFP。
见 [真实结果](../reports/v0.5-glm-calibration/paid-admission-1/README.md)。
本页保留准入范围与操作规则；两例通过不代表评审普遍可靠。
主生产对照进展见 [准备阶段停止记录](../reports/v0.5-k3-prepare-admission/README.md)。
