...
dsh plugin --profile web add "$REFRACT_REPO/dist/dsh-refractrouter-validation-0.21.0.tgz"
```
...
```bash
dsh plugin --profile headless add "$REFRACT_REPO/dist/dsh-refractrouter-validation-0.21.0.tgz"
```
