...
class BenchmarkTests(unittest.TestCase):
    ...
    def test_pareto_report_uses_quality_and_production_cost(self) -> None:
        summary = {
            "expensive": {
                "billing_unit": "AFP",
                "quality_mean": 90.0,
                "production_cost_mean": 1.0,
                "critical_path_p95_ms": 100,
            },
            "efficient": {
                "billing_unit": "AFP",
                "quality_mean": 90.0,
                "production_cost_mean": 0.5,
        ...
        self.assertIn("Production cost mean (AFP)", report)
    ...
    def test_task_oracle_uses_independent_judge_score(self) -> None:
        ...
        singles = {
            "cheap-model": replace(results["weak-all"], total_cost=0.01),
            "mid-model": replace(results["strong-all"], total_cost=0.02),
            "strong-model": replace(results["strong-all"], total_cost=0.03),
        }
